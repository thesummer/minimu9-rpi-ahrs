...
//  compass(i2cDeviceName), gyro(i2cDeviceName)
    MinIMU9(i2cDeviceName), gyro(i2cDeviceName)
{
}

//void imuUspace::checkConnection()
//{
...
//void imuUspace::enable()
//{
//    compass.enable();
//    gyro.enable();
//}

//void imuUspace::loadCalibration()
//{
