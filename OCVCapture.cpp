...
bool OCVCapture::open()
{
    ...
    static const uint32_t desiredBuffers = 1;
...
//     int matrixType = CV_8UC3;
	
	// Then set the format. This may fail since some cameras don't
	// support changing the dimensions, or the dimensions may be off.
